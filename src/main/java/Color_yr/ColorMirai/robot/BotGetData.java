...
import Color_yr.ColorMirai.plugin.socket.pack.re.FriendInfoPack;
import Color_yr.ColorMirai.plugin.socket.pack.re.GroupInfo;
import Color_yr.ColorMirai.plugin.socket.pack.re.MemberInfoPack;
