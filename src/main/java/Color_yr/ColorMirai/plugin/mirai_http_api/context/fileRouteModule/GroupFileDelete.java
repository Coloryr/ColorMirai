...
import Color_yr.ColorMirai.plugin.mirai_http_api.obj.file.FileDeleteDTO;
...
public class GroupFileDelete implements HttpHandler {
    public void handle(HttpExchange t) throws IOException {
        InputStream inputStream = t.getRequestBody();
        FileDeleteDTO obj = JSONObject.parseObject(inputStream, FileDeleteDTO.class);
        String response;
