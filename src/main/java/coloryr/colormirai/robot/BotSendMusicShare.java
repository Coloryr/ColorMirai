...
public class BotSendMusicShare {
    public static void sendFriendMusicShare(long qq, long id, int type, String title, String summary, String jumpUrl, String pictureUrl, String musicUrl) {
        MusicKind kind;
        if (type == 1) {
    ...
    public static void sendStrangerMusicShare(long qq, long id, int type, String title, String summary, String jumpUrl, String pictureUrl, String musicUrl) {
        MusicKind kind;
        if (type == 1) {
            kind = MusicKind.NeteaseCloudMusic;
        } else if (type == 2) {
