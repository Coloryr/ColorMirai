            ...
            try {
                ...
                if (task != null) {
                    ...
                    switch (task.index) {
                        ...
                        //69 [插件]设置群名片
                        case 69: {
                            plugin.addPack(new PluginPack(JSON.parseObject(task.data, GroupSetMemberCard.class), task.index));
                            break;
                        }
                        //70 [插件]设置群名
                        case 70: {
                        ...
                        //91 [插件]获取群成员信息
                        case 91: {
                            plugin.addPack(new PluginPack(JSON.parseObject(task.data, GetMemberInfo.class), task.index));
                            break;
                        }
                        //92 [插件]获取朋友信息
                        case 92: {
